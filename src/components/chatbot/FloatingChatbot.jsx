...
export const FloatingChatbot = ({ appState }) => {
  ...
  return (
    <>
      ...
      {/* ── Chat window ── */}
      <div className={`fixed bottom-6 right-6 w-96 h-[560px] rounded-2xl border border-zinc-200 shadow-xl flex flex-col z-[9999] overflow-hidden transition-all duration-300 ${
        ...
        <div className="relative flex-shrink-0 overflow-hidden">
          {/* layered backgrounds */}
          <div className="absolute inset-0 bg-gradient-to-br from-zinc-100 via-blue-50/60 to-zinc-50" />
          ...
          <div className="relative z-10 flex items-center justify-between px-5 py-4">
            ...
            <button onClick={() => setIsOpen(false)}
              ...
              className="w-8 h-8 rounded-lg bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 flex items-center justify-center text-zinc-500 hover:text-zinc-800 transition-all">
              <X size={15} />
            </button>
          </div>
        </div>
        ...
        >
          ...
          {isLoading && (
            <div className="flex justify-start gap-2" aria-label="Studio AI is typing">
              ...
              <div className="bg-zinc-50 border border-zinc-200 px-4 py-3 rounded-2xl rounded-bl-sm flex items-center gap-2.5">
        ...
        {/* ── Quick actions + input ── */}
        <div className="flex-shrink-0 bg-white border-t border-zinc-100 p-3 space-y-2.5">
          {/* quick action chips */}
          ...
          <div className="flex gap-2 items-center">
            ...
            <button onClick={handleSend} disabled={!input.trim() || isLoading}
              ...
              className="w-10 h-10 flex-shrink-0 rounded-xl flex items-center justify-center transition-all
                ...
                disabled:from-zinc-200 disabled:to-zinc-200
