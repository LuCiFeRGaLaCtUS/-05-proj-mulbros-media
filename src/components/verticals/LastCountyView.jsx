    ...
    <div className="space-y-6">
      ...
      <div className="bg-zinc-900 rounded-2xl ring-1 ring-zinc-800 p-5">
        <div className="flex items-start gap-5">
          <div className="w-16 h-20 rounded-xl bg-emerald-500/10 flex items-center justify-center flex-shrink-0">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            {streamingStats.map(s => (
              <div key={s.platform} className="bg-zinc-900 rounded-2xl ring-1 ring-zinc-800 p-5">
          ...
          <div className="bg-zinc-900 rounded-2xl ring-1 ring-zinc-800 p-5">
            <div className="text-sm font-semibold text-zinc-300 mb-3">Distribution Strategy</div>
      ...
      {activeTab === 'Campaigns' && (
        <div className="space-y-4">
          {filmCampaigns.length === 0 && (
            <div className="bg-zinc-900 rounded-2xl ring-1 ring-zinc-800 p-6 text-sm text-zinc-500">No active campaigns.</div>
          )}
          {filmCampaigns.map(c => (
            <div key={c.id} className="bg-zinc-900 rounded-2xl ring-1 ring-zinc-800 p-5">
              <div className="flex items-start justify-between mb-3">
                ...
                <span className="text-xs bg-emerald-500/10 text-emerald-400 px-2 py-0.5 rounded-full">{c.status}</span>
              </div>
