...
/**
 * Shared shell for Talent views that mostly wrap an agent.
 * Renders title + description + agent CTA + optional children (custom content above).
 */
export const TalentAgentShell = ({
  title,
  description,
  Icon,
  accentClass = 'text-sky-600',
  agentId,
  agentLabel = 'Open Chat',
  children,
  features = [],
  comingSoon = [],
}) => {
